...
if($database_name != ""){
    ...
    $sql1="SELECT SUM(`opt_6`) as `reciept_amount` FROM `$reciept_table` WHERE `opt_1`<='".$date."'"." AND `added_for`='$business'";
    // echo $sql1;
    ...
    $sql1="SELECT SUM(`opt_5`) as `payment_amount` FROM `$payment_table` WHERE `opt_1`<='$date'"." AND `added_for`='$business'";
    $result1 = mysqli_query($local_conn_db, $sql1);
    if($result1->num_rows > 0){
        while($row1 = $result1->fetch_assoc()){
    ...
    $sql1="SELECT SUM(`opt_3`) as `expense_amount` FROM `$expense_table` WHERE `opt_1`<='$date'"." AND `added_for`='$business'";
    $result1 = mysqli_query($local_conn_db, $sql1);
    if($result1->num_rows > 0){
        while($row1 = $result1->fetch_assoc()){
    ...
    $sql1="SELECT SUM(`opt_6`) as `salary_amount` FROM `$salary_table` WHERE `opt_1`<='$date'"." AND `added_for`='$business'";
    $result1 = mysqli_query($local_conn_db, $sql1);
    if($result1->num_rows > 0){
        while($row1 = $result1->fetch_assoc()){
    ...
    $sql1="SELECT SUM(`opt_5`) as `cash_deposit_amount` FROM `$cash_deposit_table` WHERE `opt_1`<='$date'"." AND `added_for`='$business'";
    $result1 = mysqli_query($local_conn_db, $sql1);
    if($result1->num_rows > 0){
        while($row1 = $result1->fetch_assoc()){
    ...
    $sql1="SELECT SUM(`opt_5`) as `cash_withdrawal_amount` FROM `$cash_withdrawal_table` WHERE `opt_1`<='$date'"." AND `added_for`='$business'";
    $result1 = mysqli_query($local_conn_db, $sql1);
    if($result1->num_rows > 0){
        while($row1 = $result1->fetch_assoc()){
