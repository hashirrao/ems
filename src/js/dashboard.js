...
function add_report_option_btn_click() {
  ...
  + '</div>'
  + '<div class="input-group mb-3" id="report_column_div">'
  + '</div>'
  + '<div class="input-group mb-3">'
  +     '<div class="input-group-prepend">'
...
function add_normal_option_btn_click() {
  ...
  document.getElementById("add_sub_option_heading").innerHTML = 'Add Option(Simple)'
  ...
  + '</div>'
  + '<div id="add_option_opt_type_and_othr_src_div"></div>'
  + '<div id="extra_options_div" class="jumbotron lesspadding" style="visibility: hidden; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 80%; z-index: 5;">'
  + '<div class="input-group mb-3">'
  +    '<div class="input-group-prepend">'
  +    '<span class="btn red btn-sm">Add Option Value</span>'
  +    '</div>'
  ...
  + '</div>'
  + '</div>'
  + '<div id="extra_values_div"></div>'
  + '<div id="value_from_other_src_div"></div>'
  + '<div id="other_sources_div"></div>'
  + '<div id="entry_options_div"></div>'
  + '<div id="entry_custom_storage_options_div"></div>';
  custom_table_options_div_show();
  add_option_input_change();
  entry_options_div_show();
...
function add_formulated_option_btn_click() {
  document.getElementById("add_panel").style.visibility = "hidden";
  document.getElementById("add_sub_options_panel").style.visibility = "visible";
  document.getElementById("add_sub_option_heading").innerHTML = 'Add Option(Formulated)'
  document.getElementById("add_sub_options_panel_content").innerHTML = '<br>'
  + '<div id="add_sub_options_panel_messageDiv"></div>'
...
function formula_row(index_of_formulas_fields){
  ...
  if (index_of_formulas_fields === 0) {
    str = ''
      // + '<div id="formula_' + index_of_formulas_fields + '">'
      ...
      + '</div>'
      + '<select id="formula_' + index_of_formulas_fields + '_operator_1" class="form-control form-control-sm select2-single" style="width: auto;">'
      + '<option>Sum</option>'
      ...
      + '<span class="btn red btn-sm">Option Name</span>'
      + '</div>'
      + '<select id="formula_' + index_of_formulas_fields + '_field_2" class="form-control form-control-sm select2-single" onchange="set_onchange_formula_select_2('+index_of_formulas_fields+')" style="width: auto;">'
      + '</select>'
      + '<div class="input-group-prepend" id="formula_span_div' + index_of_formulas_fields + '_field_2">'
      
      + '</div>'
      + '<input type="hidden" id="formula_custom' + index_of_formulas_fields + '_field_2" class="form-control form-control-sm " style="width: auto;">'
      + '</div>'
      // + '</div>'
      // + '</td>'
...
function add_grouped_option_btn_click() {
  document.getElementById("add_panel").style.visibility = "hidden";
  document.getElementById("add_sub_options_panel").style.visibility = "visible";
  document.getElementById("add_sub_option_heading").innerHTML = 'Add Option(Grouped)'
  document.getElementById("add_sub_options_panel_content").innerHTML = '<br>'
  + '<div id="add_sub_options_panel_messageDiv"></div>'
...
function group_with_select_change(){
  ...
  document.getElementById("option_against_value_inp_id") ? document.getElementById("option_against_value_inp_id").value = s.options[s.selectedIndex].text : "";
  refresh_columns_in_select("add_option_select_column", document.getElementById("add_option_select_table").value);
  setTimeout(()=>{
    document.getElementById("add_option_select_column").innerHTML += "<option>id</option>";
  }, 500);
}
...
function add_formula_btn_click(){
  ...
  // if (index_of_formulas_fields === 1) {
  //   document.getElementById("formulas_div").innerHTML += '<div id="formula_' + index_of_formulas_fields + '">'
  //     + '<div class="input-group mb-3">'
  //     + '<div class="input-group-prepend">'
  //     + '<span class="btn red btn-sm">Option Name</span>'
  //     + '</div>'
  //     + '<select id="formula_' + index_of_formulas_fields + '_field_1" class="form-control form-control-sm select2-single" onchange="set_onchange_formula_select('+index_of_formulas_fields+')">'
  //     + '</select>'
  //     + '<div class="input-group-prepend" id="formula_span_div' + index_of_formulas_fields + '_field_1">'
      
  //     + '</div>'
  //     + '<input type="hidden" id="formula_custom' + index_of_formulas_fields + '_field_1" class="form-control form-control-sm select2-single">'
  //     + '<div class="input-group-prepend">'
  //     + '<span class="btn red btn-sm">Operator</span>'
  //     + '</div>'
  ...
  //     + '<span class="btn red btn-sm">Option Name</span>'
  //     + '</div>'
  //     + '<select id="formula_' + index_of_formulas_fields + '_field_2" class="form-control form-control-sm select2-single" onchange="set_onchange_formula_select_2('+index_of_formulas_fields+')">'
  //     + '</select>'
  //     + '<div class="input-group-prepend" id="formula_span_div' + index_of_formulas_fields + '_field_2">'
      
  //     + '</div>'
  //     + '<input type="hidden" id="formula_custom' + index_of_formulas_fields + '_field_2" class="form-control form-control-sm select2-single">'
  //     + '</div>'
  //     + '</div>';
  ...
  // set_select2(index_of_formulas_fields);
...
function set_onchange_formula_select(i){
  if(document.getElementById("formula_"+i+"_field_1").value === "Custom"){
    document.getElementById("formula_span_div"+i+"_field_1").innerHTML = '<span class="btn red btn-sm">Value</span>';
...
function set_onchange_formula_select_2(i){
  if(document.getElementById("formula_"+i+"_field_2").value === "Custom"){
    document.getElementById("formula_span_div"+i+"_field_2").innerHTML = '<span class="btn red btn-sm">Value</span>';
...
function add_text_merge_table_string(table_id){
  var str = '<div style="max-height: 150px; overflow: auto;">'
...
function value_from_other_src_div_show(){
  if(document.getElementById("add_option_input_type").value === "Input Text" || document.getElementById("add_option_input_type").value === "Input Number" || document.getElementById("add_option_input_type").value === "Input Number With Point" || document.getElementById("add_option_input_type").value === "Select"){
    if(document.getElementById("value_from_other_src_div")){
      document.getElementById("value_from_other_src_div").innerHTML = '<div class="input-group mb-3">'
      +  '<div class="input-group-prepend">'
...
function custom_storage_select_change(){
  if(document.getElementById("custom_storage_select").value === "True"){
    document.getElementById("entry_custom_storage_options_div").innerHTML = '<div class="input-group mb-3">'
    +  '<div class="input-group-prepend">'
...
function custom_table_options_div_show(type){
  if(!document.getElementById("custom_table_id_options_panels_dev")){
    if(type === "grouped"){
      document.getElementById("add_option_opt_type_and_othr_src_div").innerHTML = '<div class="input-group mb-3">'
      + '<div class="input-group-prepend">'
  ...
  if(document.getElementById("add_option_other_source_value")){
    if(document.getElementById("add_option_other_source_value").value == "True"){
      if(document.getElementById("add_option_input_type").value == "Select"){
        document.getElementById("other_sources_div").innerHTML = '<div class="input-group mb-3">'
...
function settings_sub_option(id, name, type, empty_check, 
  ...
  document.getElementById("settings_sub_option_id").value = id;
  document.getElementById("settings_option_name").value = name;
  document.getElementById("settings_option_input_type").value = type;
  if(document.getElementById("settings_option_empty_check")){
    document.getElementById("settings_option_empty_check").value = empty_check;
  }
  if(document.getElementById("settings_option_similarity_check")){
    document.getElementById("settings_option_similarity_check").value = similarity_check;
  }
  settings_option_input_change();
  ...
  if(document.getElementById("settings_option_other_source_value")){
    document.getElementById("settings_option_other_source_value").value = val_frm_othr_src;
    if(typeof document.getElementById("settings_option_other_source_value").onchange == "function"){
      document.getElementById("settings_option_other_source_value").onchange();
    }
  }
  setTimeout(()=>{
    if(document.getElementById("settings_option_select_table")){
      document.getElementById("settings_option_select_table").value = othr_src_tbl;
      if(typeof document.getElementById("settings_option_select_table").onchange == "function"){
        document.getElementById("settings_option_select_table").onchange();
      }
    }
    if(document.getElementById("settings_group_with_select")){
      document.getElementById("settings_group_with_select").value = othr_src_tbl+"--"+othr_src_clm_val;
    }
    setTimeout(()=>{
      if(document.getElementById("settings_option_select_column")){
        document.getElementById("settings_option_select_column").value = othr_src_clm;
        setTimeout(()=>{
          if(othr_src_clm === "id"){
            document.getElementById("settings_option_select_column").value = othr_src_clm;
          }
      ...
      if(document.getElementById("settings_option_select_column_value")){
        document.getElementById("settings_option_select_column_value").value = othr_src_clm_val;
      }
    }, 200);
  }, 200);
  if(document.getElementById("settings_option_whole_table_search")){
    document.getElementById("settings_option_whole_table_search").value = whole_tbl_srch;
  }
  if(document.getElementById("settings_entry_type_select")){
    document.getElementById("settings_entry_type_select").value = entry_type;
    settings_entry_type_select_change();
  }
  if(document.getElementById("settings_entry_sum_select")){
    document.getElementById("settings_entry_sum_select").value = entry_sum;
  }
  if(document.getElementById("settings_custom_storage_select")){
    document.getElementById("settings_custom_storage_select").value = custom_storage;
  }
  if(document.getElementById("settings_option_editable")){
    document.getElementById("settings_option_editable").value = editable;
  }
  if(document.getElementById("settings_option_visible")){
    document.getElementById("settings_option_visible").value = visible;
  }
  if(document.getElementById("settings_option_table_visible")){
    document.getElementById("settings_option_table_visible").value = table_visible;
  }
  document.getElementById("settings_option_priority").value = priority;
  document.getElementById("settings_active_deactive").value = status;
      ...
      for (var j = 0; j < formula_arr.length; j++) {
        if (j === 2) {
          if(isNaN(formula_arr[j])){
            setSelectByText("settings_formula_" + i + "_field_2", formula_arr[j]);
          }
          else{
            setSelectByText("settings_formula_" + i + "_field_2", "Custom");
            document.getElementById("settings_formula_custom"+i+"_field_2").value = formula_arr[j];
            document.getElementById("settings_formula_" + i + "_field_2").onchange();
          }
          i++;
        }
        else {
          if (j % 2 === 0) {
            if(isNaN(formula_arr[j])){
              setSelectByText("settings_formula_" + i + "_field_1", formula_arr[j]);
            }
            else{
              setSelectByText("settings_formula_" + i + "_field_1", "Custom");
              document.getElementById("settings_formula_custom"+i+"_field_1").value = formula_arr[j];
              document.getElementById("settings_formula_" + i + "_field_1").onchange();
            }
            if (j !== 0) {
              i++;
            }
            ...
            document.getElementById("settings_formula_" + i + "_operator_1").value = formula_arr[j];
          }
        }
      }
    }, 1000);
  ...
  document.getElementById("settings_sub_options_panel").style.visibility = "visible";
}
...
function settings_normal_option(){ 
  document.getElementById("settings_sub_option_heading").innerHTML = 'Option Settings(Simple)'
  document.getElementById("settings_sub_options_panel_content").innerHTML = '<br>'
  + '<div id="settings_sub_options_panel_messageDiv"></div>'
  + '<input type="hidden" id="settings_field_type" value="Normal">'
  + '<input type="hidden" id="settings_sub_option_id" class="form-control form-control-sm" placeholder="Option ID">'
  + '<div class="input-group mb-3">'
  +    '<div class="input-group-prepend">'
  +        '<span class="btn red btn-sm">Option Name</span>'
  +    '</div>'
  +    '<input type="text" id="settings_option_name" class="form-control form-control-sm" placeholder="Option Name">'
  + '</div>'
  + '<div id="settings_option_opt_type_and_othr_src_div"></div>'
  + '<div id="settings_extra_options_div" class="jumbotron lesspadding" style="visibility: hidden; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 80%; z-index: 5;">'
  + '<div class="input-group mb-3">'
  +    '<div class="input-group-prepend">'
  +    '<span class="btn red btn-sm">Add Option Value</span>'
  +    '</div>'
  +    '<input type="text" id="settings_option_input" class="form-control form-control-sm" placeholder="Add Option Value">'
  +    '<div class="input-group-append">'
  +      '<button class="input-group-text btn btn-success" onclick="settings_options_add_btn_click()"><span class="fa fa-arrow-right"></span></button>'
  +      '<button class="input-group-text btn btn-danger" onclick="settings_close_option_btn_click()"><span class="fa fa-times"></span></button>'
  +    '</div>'
  + '</div>'
  + '</div>'
  + '<div id="settings_extra_values_div"></div>'
  + '<div id="settings_value_from_other_src_div"></div>'
  + '<div id="settings_other_sources_div"></div>'
  + '<div id="settings_entry_options_div"></div>'
  + '<div id="settings_entry_custom_storage_options_div"></div>'
  + '<div class="input-group mb-3">'
  +    '<div class="input-group-prepend">'
  +    '<span class="btn red btn-sm">Priority</span>'
  +    '</div>'
  +    '<input type="number" id="settings_option_priority" class="form-control form-control-sm" placeholder="Priority">'
  +    '<div class="input-group-prepend">'
  +    '<span class="btn red btn-sm">Status</span>'
  +    '</div>'
  +    '<select id="settings_active_deactive" class="form-control form-control-sm select2-single">'
...
function settings_formulated_option(){ 
  document.getElementById("settings_sub_option_heading").innerHTML = 'Option Settings(Formulated)'
  document.getElementById("settings_sub_options_panel_content").innerHTML = '<br>'
  + '<div id="settings_sub_options_panel_messageDiv"></div>'
  + '<input type="hidden" id="settings_field_type" value="Formulated">'
  + '<input type="hidden" id="settings_sub_option_id" class="form-control form-control-sm" placeholder="Option ID">'
  + '<div class="input-group mb-3">'
  +    '<div class="input-group-prepend">'
  +        '<span class="btn red btn-sm">Option Name</span>'
  ...
  +        '<span class="btn red btn-sm">Editable</span>'
  +    '</div>'
  +    '<select id="settings_option_editable" class="form-control form-control-sm select2-single">'
  +      '<option>False</option>'
  +      '<option>True</option>'
  +    '</select>'
  +    '<div class="input-group-prepend">'
  +        '<span class="btn red btn-sm">Visible</span>'
  +    '</div>'
  +    '<select id="settings_option_visible" class="form-control form-control-sm select2-single">'
  +     '<option>False</option>'
  +     '<option>True</option>'
  +    '</select>'
  +    '<div class="input-group-prepend">'
  +        '<span class="btn red btn-sm">Table Visible</span>'
  +    '</div>'
  +    '<select id="settings_option_table_visible" class="form-control form-control-sm select2-single">'
  +     '<option>True</option>'
  +     '<option>False</option>'
  +    '</select>'
  + '</div>'
  ...
  + '</div>'
  + '<div>'
  +    '<button style="float: right; margin-bottom: 5px; margin-right: 5px;" class="btn btn-default" onclick="settings_formula_btn_click()"><span class="fa fa-plus"></span> Add Formula</button>'
  +    '<button style="float: right; margin-bottom: 5px; margin-right: 5px;" class="btn btn-default" onclick="settings_formula_reset_btn_click()"><span class="fa fa-undo"></span> Reset Formula</button>'
  + '</div>'
  + '<div id="settings_formulas_div"></div>';
  document.getElementById("settings_formulas_div").innerHTML = "";
  settings_index_of_formulas_fields = 0;
  settings_formula_btn_click();
  settings_custom_table_options_div_show("formulated");
  settings_entry_options_div_show();
}

function settings_grouped_option(){ 
  document.getElementById("settings_sub_option_heading").innerHTML = 'Option Settings(Grouped)'
  document.getElementById("settings_sub_options_panel_content").innerHTML = '<br>'
  + '<div id="settings_sub_options_panel_messageDiv"></div>'
  + '<input type="hidden" id="settings_field_type" value="Grouped">'
  + '<input type="hidden" id="settings_sub_option_id" class="form-control form-control-sm" placeholder="Option ID">'
  + '<div class="input-group mb-3">'
  +     '<div class="input-group-prepend">'
  +         '<span class="btn red btn-sm">Group With</span>'
  +     '</div>'
  +     '<select id="settings_group_with_select" class="form-control form-control-sm select2-single" onchange="settings_group_with_select_change()">'
  +     '</select>'
  + '</div>'
  + '<div class="input-group mb-3">'
  +     '<div class="input-group-prepend">'
  ...
  document.getElementById("settings_other_sources_div").innerHTML = '<input id="settings_option_other_source_value" type="hidden" value="True" >'
    + '<input id="settings_option_select_table" type="hidden" value="True" >'
    + '<input id="settings_option_select_column_value" type="hidden">'
    + '<input id="settings_option_against_value_inp_id" type="hidden">'
    + '<div class="input-group mb-3">'
    + '<div class="input-group-prepend">'
    +    '<span class="btn red btn-sm">Columns</span>'
    + '</div>'
    ...
    + '</div>'
    + '</div>';
  settings_custom_table_options_div_show("grouped");
  settings_entry_options_div_show();
  setTimeout(settings_group_with_select_change, 500);
  var table_name = "";
  if(document.getElementById("entry_id_options_panels_dev")){
    table_name = "entry_"+document.getElementById("entry_id_options_panels_dev").innerHTML;
  }
  ...
  refresh_options('settings_group_with_select', table_name, "grouped", "false");
}

function settings_group_with_select_change(){
  document.getElementById("settings_option_select_table").value = document.getElementById("settings_group_with_select").value.split("--")[0];
  document.getElementById("settings_option_select_column_value").value = document.getElementById("settings_group_with_select").value.split("--")[1];
  var s = document.getElementById("settings_group_with_select");
  document.getElementById("settings_option_against_value_inp_id").value = s.options[s.selectedIndex].text;
  ...
  setTimeout(()=>{
    document.getElementById("settings_option_select_column").innerHTML += "<option>id</option>";
  }, 500);
}
...
function settings_entry_type_select_change(){
  ...
  if(document.getElementById("settings_entry_type_select").value === "Multiple"){
    document.getElementById("settings_entry_options_div").innerHTML = '<div class="input-group mb-3">'
    +  '<div class="input-group-prepend">'
    +     '<span class="btn red btn-sm">Entry Type</span>'
    +   '</div>'
...
function settings_custom_storage_select_change(){
  if(document.getElementById("settings_custom_storage_select").value === "True"){
    document.getElementById("settings_entry_custom_storage_options_div").innerHTML = '<div class="input-group mb-3">'
    +  '<div class="input-group-prepend">'
...
function settings_custom_table_options_div_show(type){
  if(!document.getElementById("custom_table_id_options_panels_dev")){
    if(type === "Grouped"){
      document.getElementById("settings_option_opt_type_and_othr_src_div").innerHTML = '<div class="input-group mb-3">'
      + '<div class="input-group-prepend">'
      +    '<span class="btn red btn-sm">Option Type</span>'
      + '</div>'
...
function settings_value_from_other_src_div_show(){
  if(document.getElementById("settings_option_input_type").value === "Input Text" || document.getElementById("settings_option_input_type").value === "Input Number" || document.getElementById("settings_option_input_type").value === "Input Number With Point" || document.getElementById("settings_option_input_type").value === "Select"){
    document.getElementById("settings_value_from_other_src_div").innerHTML = '<div class="input-group mb-3">'
    +  '<div class="input-group-prepend">'
    +     '<span class="btn red btn-sm">Values From Other Source</span>'
    +   '</div>'
  ...
  if(document.getElementById("settings_option_other_source_value")){
    if(document.getElementById("settings_option_other_source_value").value == "True"){
      if(document.getElementById("settings_option_input_type").value == "Select"){
        document.getElementById("settings_other_sources_div").innerHTML = '<div class="input-group mb-3">'
        + '<div class="input-group-prepend">'
        +      '<span class="btn red btn-sm">Tables</span>'
        + '</div>'
