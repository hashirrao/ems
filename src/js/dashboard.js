...
function settings_normal_option(){ 
  ...
  +   '</div>'
  + '</div>'
  + '<div class="row" id="settings_option_opt_type_and_othr_src_div"></div>'
  + '<div class="row" id="settings_extra_options_div" class="jumbotron lesspadding" style="visibility: hidden; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 80%; z-index: 5;">'
  +    '<div class="input-group-prepend">'
  +    '<span class="btn label-fill btn-sm">Add Option Value</span>'
  +    '</div>'
  ...
  +    '</div>'
  + '<div class="row" id="settings_extra_values_div"></div>'
  + '<div class="row" id="settings_value_from_other_src_div"></div>'
  + '<div class="row" id="settings_other_sources_div"></div>'
  + '<div class="row" id="settings_entry_options_div"></div>'
  + '<div class="row" id="settings_entry_custom_storage_options_div"></div>'
  + '<div class="row">'
  +   '<div class="col-md-6 col-sm-12">'
